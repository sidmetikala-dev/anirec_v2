...
from anirec.anime_recommender import KNNRegressor
...
from anirec.mal_client import MALClient
        ...
        with pool.connection() as conn:
            with conn.cursor() as cur:
                ...
                """, (
                    ...
                    recommendations["picture_link"].tolist(),
                    rank_positions,
